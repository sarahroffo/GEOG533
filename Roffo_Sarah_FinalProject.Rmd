...
The test data will consist of a survey conducted by the University of Rhode Island for the 2014 report, 'Immigrants and Immigration in the Ocean State: History, Demography, Public Opinion, and Policy Responses'. Specifically, the data is gathered from the Public Opinion Section of this report. 300 residents of Rhode Island were surveyed with 100 residents being in the 18-35 year age group, 100 residents being in the 36-55 age group, and 100 residents being in the 56+ age group. 

The negative perception of immigrants variable is determined based on the survey respondents' answers to whether they feel that 'Immigrants today are a burden on our state because they take our jobs, housing, and health care'. 

##Age and Negative Perception
...
Scatter Plot of the relationship between age and perception:
```{r}
plot(age, negative_perception)
```

Negative perception of immigrants is generally more prominent among those in higher age groups.

##Educational Attainment and Negative Perception
Correlation between level of educational attainment and negative perception:
```{r}
education <- c(25, 50, 0)
negative_perception1 <- c(.23, .13, 0)
#where 25 = High School graduate or less and 50 = educated beyond high school, and 0 is a placeholder value
...
#If p-value is < 0.05, we accept the null hypothesis
print('We reject the null hypothesis that there is no relationship between level of educational attainment and perception of immigrants.')
```

Scatter Plot of the relationship between level of educational attainment and perception:
```{r}
plot(education, negative_perception1)
```

Negative perception of immigrants generally lowers with higher levels of educational attainment.

##Conclusion
From the statistical analysis, we can conclude that there is a positive relationship between the negative perception of immigrants and both increasing age and lower levels of educational attainment in the state of Rhode Island. 
