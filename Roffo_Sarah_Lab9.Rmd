...
```{r}
print('From the variance inflation factors, I conclude that ____________')
```
...
```{r}
predicted_sales_price <- 1.57 * 40000 + 23.4 * 1500 - 9.5 * 6000
...
print('The improved model excluded the bedrooms independent variable.')
```
...
improved_regression <- step(m, direction = "backward")
summary(improved_regression)
print('No independent variables are excluded.')
```
